...
# ===== System Parameters =====
norm_time = 100000                    # 500,000 used in paper
PS_order = 15                          # Max Power Series Order, system will truncate
KE_particle = npfloat(20e3)            # eV
B_0 = npfloat(-3.12e-5)                # T
mass=m_e                               # m_e or m_p


# ===== Number of Steps  =====
rk4_step = npfloat(0.4)                
ps_step=rk4_step/scale_time            # set equal for one-to-one comparison, can be anything
ps_step=2

# ===== Initial Conditions (Position & Velocity) =====
x_initial = npfloat(4)                 # all in RE
y_initial = npfloat(0)
z_initial = npfloat(.5)
pitch_deg = npfloat(65.0)              # equatorial pitch angle, 30-60 for good bounce
