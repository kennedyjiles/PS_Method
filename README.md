...
python constB.py
```
Simulating the trajectory of a 100 eV electron for about 10 gyroperiods in constant magnetic field. Expected outputs are saved under `outputs_demo/` with trajectory and error summaries.
...
Upon first running, a simulation will create an outputs folder in the working directory, e.g.:
